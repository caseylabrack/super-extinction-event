...
--😐
	--spino mode has a shark?
		--fin appears, jaws music starts
		--he does a normal kill
	--graph of score?
...
--	pal({[0]=0,129,130,131,132,133,134,135,136,137,138,139,140,141,142,143},1)
	...
	menuitem(1,"erase data", function () for i=1,10 do dset(i,-1) end oldhs=0 end)
...
function _update()
	...
	local patt=stat"54"
	--total game time (0..1)
	g⧗=(patt*32+note)/(15*32-16)
	--big one shake time when <0
	bo⧗=(14*32)-(patt*32+note)
...
--				if e2⧗%(flr(60/nscore))==0 then
				if e2⧗%4==0 then
					...
					z.y=0
					z.⧗=30 z.c=9
					z.dx,z.dy=rndr(-1.5,-0.5),rndr(-2,2)
					if chal==3 then
						z.dx,z.dy=0,rndr(-4,-2)
					end
					z.f=.8
					z.type="text"
			...
			for os in all(oldscores) do
				circ(-34+(34*2)*(os/endline),0,1,11)
			end
			...
			if oldhs>0 then print("best",hsmark-6,5,col) end
...
__sfx__

...

__music__
00 00414344
00 01424344
00 02424344
