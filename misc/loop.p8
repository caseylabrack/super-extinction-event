...
--  distance=2.5-⧗/1000
  ...
  distance=3.1-abs(cos((⧗+188)/750))
--  distance=8-abs(cos((⧗+188)/750))*2
...
--		local x1,y1=mid(-63,a.x,63),mid(-64,a.y,64)
--		local x2,y2=mid(-63,b.x,63),mid(-64,b.y,64)
-- 	line(x1,y1,x2,y2)

--		if a.x>-64 and a.x<64 and
--			a.y>-64 and a.y<64 and
--			b.x>-64 and b.x<64 and
--			b.y>-64 and b.y<64 then
  	line(a.x,a.y,b.x,b.y)
--  end
